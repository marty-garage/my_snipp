...
public class Start
{
	//final static Logger logger = LoggerFactory.getLogger(WicketGlobalPage.class);
	/**
	...
	public static void main(String[] args)
	{
        ...
        //my_log.debug("into start");
		System.setProperty("wicket.configuration", "development");

		logger.severe("into start0");
		...
		{
            logger.info("into catch"+e.getMessage());
			e.printStackTrace();
			System.exit(100);
		}
	}
